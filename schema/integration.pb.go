...
func (x *Integration) GetDockerfile() string {
	if x != nil {
		return x.Dockerfile
	}
	return ""
...
var file_schema_integration_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0x41, 0x0a,
	0x0b, 0x49, 0x6e, 0x74, 0x65, 0x67, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04,
...
var file_schema_integration_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
