...
func (*ImageBuildPlan_DockerBuild_AttrsByPlatform) Descriptor() ([]byte, []int) {
	return file_schema_binary_proto_rawDescGZIP(), []int{1, 7, 0}
}
...
var file_schema_binary_proto_rawDesc = []byte{
	...
	0x05, 0x10, 0x06, 0x4a, 0x04, 0x08, 0x07, 0x10, 0x08, 0x22, 0xdc, 0x0f, 0x0a, 0x0e, 0x49, 0x6d,
	...
	0x03, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x1a, 0xe2, 0x02, 0x0a, 0x0b, 0x44, 0x6f, 0x63, 0x6b,
	...
	0x72, 0x6d, 0x1a, 0xc7, 0x01, 0x0a, 0x0f, 0x41, 0x74, 0x74, 0x72, 0x73, 0x42, 0x79, 0x50, 0x6c,
...
var file_schema_binary_proto_goTypes = []interface{}{
	...
	(*ImageBuildPlan_DockerBuild_AttrsByPlatform)(nil), // 12: foundation.schema.ImageBuildPlan.DockerBuild.AttrsByPlatform
	nil,                           // 13: foundation.schema.ImageBuildPlan.DockerBuild.AttrsByPlatform.AttrsEntry
...
var file_schema_binary_proto_depIdxs = []int32{
	...
	16, // 6: foundation.schema.ImageBuildPlan.nodejs_build:type_name -> foundation.schema.NodejsBuild
	17, // 7: foundation.schema.ImageBuildPlan.binary:type_name -> foundation.schema.PackageRef
	...
	14, // 14: foundation.schema.BinaryConfig.env:type_name -> foundation.schema.BinaryConfig.EnvEntry
	...
	12, // 19: foundation.schema.ImageBuildPlan.DockerBuild.attrs_by_platform:type_name -> foundation.schema.ImageBuildPlan.DockerBuild.AttrsByPlatform
	13, // 20: foundation.schema.ImageBuildPlan.DockerBuild.AttrsByPlatform.attrs:type_name -> foundation.schema.ImageBuildPlan.DockerBuild.AttrsByPlatform.AttrsEntry
	18, // 21: foundation.schema.BinaryConfig.EnvEntry.value:type_name -> foundation.schema.Resolvable
