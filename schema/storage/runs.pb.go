...
func (x *RunBundle) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RunBundle) ProtoMessage() {}

func (x *RunBundle) ProtoReflect() protoreflect.Message {
	mi := &file_schema_storage_runs_proto_msgTypes[0]
...
// Deprecated: Use RunBundle.ProtoReflect.Descriptor instead.
...
var file_schema_storage_runs_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x22, 0x0b, 0x0a, 0x09, 0x52, 0x75, 0x6e, 0x42, 0x75, 0x6e,
	0x64, 0x6c, 0x65, 0x42, 0x2d, 0x5a, 0x2b, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65,
...
var file_schema_storage_runs_proto_goTypes = []interface{}{
	(*RunBundle)(nil), // 0: foundation.schema.storage.RunBundle
}
