...
type Test struct {
	...
	Driver           *Binary  `protobuf:"bytes,3,opt,name=driver,proto3" json:"driver,omitempty"`
...
var file_schema_test_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xde, 0x01, 0x0a, 0x04, 0x54, 0x65, 0x73, 0x74, 0x12, 0x21,
	...
	0x52, 0x06, 0x64, 0x72, 0x69, 0x76, 0x65, 0x72, 0x12, 0x2a, 0x0a, 0x10, 0x73, 0x65, 0x72, 0x76,
...
var file_schema_test_proto_goTypes = []interface{}{
	...
	(*Integration)(nil), // 2: foundation.schema.Integration
}
var file_schema_test_proto_depIdxs = []int32{
	1, // 0: foundation.schema.Test.driver:type_name -> foundation.schema.Binary
	2, // 1: foundation.schema.Test.integration:type_name -> foundation.schema.Integration
