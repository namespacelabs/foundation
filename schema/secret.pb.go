...
func (x *SecretSpec) GetOwner() string {
	if x != nil {
		return x.Owner
	}
	return ""
...
func (x *SecretSpec) GetOptional() bool {
	if x != nil {
		return x.Optional
	}
	return false
...
var file_schema_secret_proto_rawDesc = []byte{
	...
	0x6e, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0x74, 0x0a, 0x0a, 0x53, 0x65, 0x63, 0x72,
	0x65, 0x74, 0x53, 0x70, 0x65, 0x63, 0x12, 0x14, 0x0a, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x18,
	...
	0x6f, 0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x61, 0x6c, 0x42, 0x25,
...
var file_schema_secret_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_schema_secret_proto_goTypes = []interface{}{
	(*SecretSpec)(nil), // 0: foundation.schema.SecretSpec
}
