...
type ConfigurableVolume_Entry struct {
	...
	KubernetesSecretRef *ConfigurableVolume_Entry_KubernetesSecret `protobuf:"bytes,5,opt,name=kubernetes_secret_ref,json=kubernetesSecretRef,proto3" json:"kubernetes_secret_ref,omitempty"`
}
...
func (x *ConfigurableVolume_Entry) GetKubernetesSecretRef() *ConfigurableVolume_Entry_KubernetesSecret {
	if x != nil {
...
type ConfigurableVolume_Entry_KubernetesSecret struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ConfigurableVolume_Entry_KubernetesSecret) Reset() {
	*x = ConfigurableVolume_Entry_KubernetesSecret{}
	if protoimpl.UnsafeEnabled {
...
func (x *ConfigurableVolume_Entry_KubernetesSecret) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ConfigurableVolume_Entry_KubernetesSecret) ProtoMessage() {}

func (x *ConfigurableVolume_Entry_KubernetesSecret) ProtoReflect() protoreflect.Message {
	mi := &file_schema_volume_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ConfigurableVolume_Entry_KubernetesSecret.ProtoReflect.Descriptor instead.
func (*ConfigurableVolume_Entry_KubernetesSecret) Descriptor() ([]byte, []int) {
	return file_schema_volume_proto_rawDescGZIP(), []int{4, 0, 0}
}

func (x *ConfigurableVolume_Entry_KubernetesSecret) GetSecretName() string {
	if x != nil {
		return x.SecretName
	}
	return ""
...
func (x *ConfigurableVolume_Entry_KubernetesSecret) GetSecretKey() string {
	if x != nil {
		return x.SecretKey
	}
	return ""
...
var file_schema_volume_proto_rawDesc = []byte{
	...
	0x7a, 0x65, 0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0xd2, 0x03, 0x0a, 0x12, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x74, 0x72, 0x69, 0x65, 0x73, 0x1a, 0xf4, 0x02, 0x0a, 0x05, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12,
	...
	0x6c, 0x69, 0x6e, 0x65, 0x53, 0x65, 0x74, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x63, 0x72, 0x65,
	0x74, 0x5f, 0x72, 0x65, 0x66, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x65, 0x63,
	0x72, 0x65, 0x74, 0x52, 0x65, 0x66, 0x12, 0x70, 0x0a, 0x15, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e,
	0x65, 0x74, 0x65, 0x73, 0x5f, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x5f, 0x72, 0x65, 0x66, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x3c, 0x2e, 0x66, 0x6f, 0x75, 0x6e, 0x64, 0x61, 0x74, 0x69,
	...
	0x72, 0x79, 0x2e, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53, 0x65, 0x63,
	0x72, 0x65, 0x74, 0x52, 0x13, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53,
	0x65, 0x63, 0x72, 0x65, 0x74, 0x52, 0x65, 0x66, 0x1a, 0x52, 0x0a, 0x10, 0x4b, 0x75, 0x62, 0x65,
	0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x12, 0x1f, 0x0a, 0x0b,
	...
	0x09, 0x52, 0x09, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x4b, 0x65, 0x79, 0x22, 0x46, 0x0a, 0x0b,
	0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x65, 0x74, 0x12, 0x37, 0x0a, 0x08, 0x72,
	0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e,
	...
	0x75, 0x72, 0x63, 0x65, 0x22, 0x4e, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
...
var file_schema_volume_proto_goTypes = []interface{}{
	...
	(*ConfigurableVolume_Entry_KubernetesSecret)(nil), // 8: foundation.schema.ConfigurableVolume.Entry.KubernetesSecret
...
var file_schema_volume_proto_depIdxs = []int32{
	...
	8, // 5: foundation.schema.ConfigurableVolume.Entry.kubernetes_secret_ref:type_name -> foundation.schema.ConfigurableVolume.Entry.KubernetesSecret
...
func file_schema_volume_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_schema_volume_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConfigurableVolume_Entry_KubernetesSecret); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
