...
func (*ConfigurableVolume_Entry) Descriptor() ([]byte, []int) {
	return file_schema_volume_proto_rawDescGZIP(), []int{5, 0}
}
...
func (*ConfigurableVolume_Entry_KubernetesSecretRef) Descriptor() ([]byte, []int) {
	return file_schema_volume_proto_rawDescGZIP(), []int{5, 0, 0}
}
...
var file_schema_volume_proto_rawDesc = []byte{
	...
	0x09, 0x73, 0x69, 0x7a, 0x65, 0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0x29, 0x0a, 0x13, 0x57, 0x6f,
...
var file_schema_volume_proto_goTypes = []interface{}{
	...
	(*WorkspaceSyncVolume)(nil),                          // 4: foundation.schema.WorkspaceSyncVolume
	(*ConfigurableVolume)(nil),                           // 5: foundation.schema.ConfigurableVolume
	(*ResourceSet)(nil),                                  // 6: foundation.schema.ResourceSet
...
var file_schema_volume_proto_depIdxs = []int32{
	...
	7,  // 3: foundation.schema.ResourceSet.resource:type_name -> foundation.schema.FileContents
	7,  // 4: foundation.schema.ConfigurableVolume.Entry.inline:type_name -> foundation.schema.FileContents
	6,  // 5: foundation.schema.ConfigurableVolume.Entry.inline_set:type_name -> foundation.schema.ResourceSet
