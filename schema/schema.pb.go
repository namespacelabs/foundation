...
type Volume_Kind int32

const (
	Volume_KIND_UNSPECIFIED Volume_Kind = 0
	Volume_EPHEMERAL        Volume_Kind = 1
	Volume_PERSISTENT       Volume_Kind = 2
	Volume_CONFIGURABLE     Volume_Kind = 3
	Volume_PACKAGE_SYNC     Volume_Kind = 4
)

// Enum value maps for Volume_Kind.
var (
	Volume_Kind_name = map[int32]string{
		0: "KIND_UNSPECIFIED",
		1: "EPHEMERAL",
		2: "PERSISTENT",
		3: "CONFIGURABLE",
	...
	Volume_Kind_value = map[string]int32{
		"KIND_UNSPECIFIED": 0,
		"EPHEMERAL":        1,
		"PERSISTENT":       2,
		"CONFIGURABLE":     3,
...
func (x Volume_Kind) Enum() *Volume_Kind {
	p := new(Volume_Kind)
	*p = x
	return p
}

func (x Volume_Kind) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Volume_Kind) Descriptor() protoreflect.EnumDescriptor {
	return file_schema_schema_proto_enumTypes[3].Descriptor()
}

func (Volume_Kind) Type() protoreflect.EnumType {
	return &file_schema_schema_proto_enumTypes[3]
}

func (x Volume_Kind) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Volume_Kind.Descriptor instead.
func (Volume_Kind) EnumDescriptor() ([]byte, []int) {
...
func (Environment_Purpose) Descriptor() protoreflect.EnumDescriptor {
	return file_schema_schema_proto_enumTypes[4].Descriptor()
}

func (Environment_Purpose) Type() protoreflect.EnumType {
	return &file_schema_schema_proto_enumTypes[4]
}
...
func (Environment_Purpose) EnumDescriptor() ([]byte, []int) {
	return file_schema_schema_proto_rawDescGZIP(), []int{14, 0}
}
...
type Volume struct {
	...
	Kind Volume_Kind `protobuf:"varint,1,opt,name=kind,proto3,enum=foundation.schema.Volume_Kind" json:"kind,omitempty"`
	...
	// At most one of these is set by the parser.
	Persistent   *Volume_Persistent     `protobuf:"bytes,101,opt,name=persistent,proto3" json:"persistent,omitempty"`
	Configurable []*Volume_Configurable `protobuf:"bytes,102,rep,name=configurable,proto3" json:"configurable,omitempty"`
	PackageSync  *Volume_Fileset        `protobuf:"bytes,103,opt,name=package_sync,json=packageSync,proto3" json:"package_sync,omitempty"`
}
...
func (x *Volume) GetKind() Volume_Kind {
	if x != nil {
		return x.Kind
	}
	return Volume_KIND_UNSPECIFIED
}
...
func (*Server_Mount) Descriptor() ([]byte, []int) {
	return file_schema_schema_proto_rawDescGZIP(), []int{10, 6}
}
...
type Volume_Configurable struct {
	...
	// One of these
	SourceContent        string `protobuf:"bytes,2,opt,name=source_content,json=sourceContent,proto3" json:"source_content,omitempty"` // Inlined content
	...
	SourceSecretFilePath string `protobuf:"bytes,4,opt,name=source_secret_file_path,json=sourceSecretFilePath,proto3" json:"source_secret_file_path,omitempty"`
...
func (x *Volume_Configurable) Reset() {
	*x = Volume_Configurable{}
	if protoimpl.UnsafeEnabled {
		mi := &file_schema_schema_proto_msgTypes[35]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Volume_Configurable) Descriptor() ([]byte, []int) {
	return file_schema_schema_proto_rawDescGZIP(), []int{11, 1}
}

func (x *Volume_Configurable) GetTargetPath() string {
	if x != nil {
		return x.TargetPath
	}
	return ""
...
func (x *Volume_Configurable) GetSourceContent() string {
	if x != nil {
...
func (x *Volume_Configurable) GetSourceFilePath() string {
	if x != nil {
...
func (x *Volume_Configurable) GetSourceSecretFilePath() string {
	if x != nil {
		return x.SourceSecretFilePath
	}
	return ""
}

func (x *Volume_Configurable) GetSourceDir() string {
	if x != nil {
		return x.SourceDir
	}
	return ""
...
func (x *Volume_Fileset) Reset() {
	*x = Volume_Fileset{}
	if protoimpl.UnsafeEnabled {
		mi := &file_schema_schema_proto_msgTypes[36]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Volume_Fileset) Descriptor() ([]byte, []int) {
	return file_schema_schema_proto_rawDescGZIP(), []int{11, 2}
}
...
func (x *Allocation_Instance) Reset() {
	*x = Allocation_Instance{}
	if protoimpl.UnsafeEnabled {
		mi := &file_schema_schema_proto_msgTypes[37]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Allocation_Instance) Descriptor() ([]byte, []int) {
	return file_schema_schema_proto_rawDescGZIP(), []int{12, 0}
}
...
func (x *Environment_Label) Reset() {
	*x = Environment_Label{}
	if protoimpl.UnsafeEnabled {
		mi := &file_schema_schema_proto_msgTypes[38]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *Naming_AdditionalDomainName) Reset() {
	*x = Naming_AdditionalDomainName{}
	if protoimpl.UnsafeEnabled {
		mi := &file_schema_schema_proto_msgTypes[39]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Naming_AdditionalDomainName) Descriptor() ([]byte, []int) {
	return file_schema_schema_proto_rawDescGZIP(), []int{18, 0}
}
...
var file_schema_schema_proto_rawDesc = []byte{
	...
	0x52, 0x4f, 0x54, 0x4f, 0x5f, 0x44, 0x45, 0x50, 0x53, 0x10, 0x04, 0x22, 0xae, 0x11, 0x0a, 0x06,
	...
	,
	...
	0x65, 0x4e, 0x61, 0x6d, 0x65, 0x1a, 0xcf, 0x01, 0x0a, 0x0b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	,
	...
	,
	...
	0x4a, 0x04, 0x08, 0x11, 0x10, 0x12, 0x4a, 0x04, 0x08, 0x13, 0x10, 0x14, 0x22, 0x92, 0x06, 0x0a,
	0x06, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x12, 0x32, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x66, 0x6f, 0x75, 0x6e, 0x64, 0x61, 0x74, 0x69,
	...
	,
	...
	,
	...
	0x6f, 0x62, 0x75, 0x66, 0x2e, 0x41, 0x6e, 0x79, 0x52, 0x0b, 0x63, 0x6f, 0x6e, 0x73, 0x74, 0x72,
	0x75, 0x63, 0x74, 0x6f, 0x72, 0x22, 0xda, 0x02, 0x0a, 0x0b, 0x45, 0x6e, 0x76, 0x69, 0x72, 0x6f,
	...
	0x69, 0x6d, 0x65, 0x12, 0x40, 0x0a, 0x07, 0x70, 0x75, 0x72, 0x70, 0x6f, 0x73, 0x65, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x26, 0x2e, 0x66, 0x6f, 0x75, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x45, 0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e,
	0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x50, 0x75, 0x72, 0x70, 0x6f, 0x73, 0x65, 0x52, 0x07, 0x70, 0x75,
	0x72, 0x70, 0x6f, 0x73, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x65, 0x70, 0x68, 0x65, 0x6d, 0x65, 0x72,
	0x61, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x65, 0x70, 0x68, 0x65, 0x6d, 0x65,
	0x72, 0x61, 0x6c, 0x12, 0x3c, 0x0a, 0x06, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x18, 0x05, 0x20,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_schema_schema_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_schema_schema_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_schema_schema_proto_goTypes = []interface{}{
	...
	(Volume_Kind)(0),                      // 3: foundation.schema.Volume.Kind
	(Environment_Purpose)(0),              // 4: foundation.schema.Environment.Purpose
	(*Schema)(nil),                        // 5: foundation.schema.Schema
	(*Stack)(nil),                         // 6: foundation.schema.Stack
	(*Node)(nil),                          // 7: foundation.schema.Node
	(*NodeInitializer)(nil),               // 8: foundation.schema.NodeInitializer
	(*HttpPath)(nil),                      // 9: foundation.schema.HttpPath
	(*Need)(nil),                          // 10: foundation.schema.Need
	(*Provides)(nil),                      // 11: foundation.schema.Provides
	(*TypeDef)(nil),                       // 12: foundation.schema.TypeDef
	(*GrpcExportService)(nil),             // 13: foundation.schema.GrpcExportService
	(*Reference)(nil),                     // 14: foundation.schema.Reference
	(*Server)(nil),                        // 15: foundation.schema.Server
	(*Volume)(nil),                        // 16: foundation.schema.Volume
	(*Allocation)(nil),                    // 17: foundation.schema.Allocation
	(*Instantiate)(nil),                   // 18: foundation.schema.Instantiate
	(*Environment)(nil),                   // 19: foundation.schema.Environment
	(*Platform)(nil),                      // 20: foundation.schema.Platform
	(*HttpExportedService)(nil),           // 21: foundation.schema.HttpExportedService
	(*RequiredStorage)(nil),               // 22: foundation.schema.RequiredStorage
	(*Naming)(nil),                        // 23: foundation.schema.Naming
	(*ComputedNaming)(nil),                // 24: foundation.schema.ComputedNaming
	(*Stack_Entry)(nil),                   // 25: foundation.schema.Stack.Entry
	(*Node_EnvironmentRequirement)(nil),   // 26: foundation.schema.Node.EnvironmentRequirement
	(*Need_Port)(nil),                     // 27: foundation.schema.Need.Port
	(*Provides_AvailableIn)(nil),          // 28: foundation.schema.Provides.AvailableIn
	(*Provides_AvailableIn_Go)(nil),       // 29: foundation.schema.Provides.AvailableIn.Go
	(*Provides_AvailableIn_Web)(nil),      // 30: foundation.schema.Provides.AvailableIn.Web
	(*Provides_AvailableIn_NodeJs)(nil),   // 31: foundation.schema.Provides.AvailableIn.NodeJs
	(*Server_Binary)(nil),                 // 32: foundation.schema.Server.Binary
	(*Server_ServiceSpec)(nil),            // 33: foundation.schema.Server.ServiceSpec
	(*Server_URLMapEntry)(nil),            // 34: foundation.schema.Server.URLMapEntry
	(*Server_Description)(nil),            // 35: foundation.schema.Server.Description
	(*Server_EnvironmentRequirement)(nil), // 36: foundation.schema.Server.EnvironmentRequirement
	(*Server_Integration)(nil),            // 37: foundation.schema.Server.Integration
	(*Server_Mount)(nil),                  // 38: foundation.schema.Server.Mount
	(*Volume_Persistent)(nil),             // 39: foundation.schema.Volume.Persistent
	(*Volume_Configurable)(nil),           // 40: foundation.schema.Volume.Configurable
	(*Volume_Fileset)(nil),                // 41: foundation.schema.Volume.Fileset
	(*Allocation_Instance)(nil),           // 42: foundation.schema.Allocation.Instance
	(*Environment_Label)(nil),             // 43: foundation.schema.Environment.Label
	(*Naming_AdditionalDomainName)(nil),   // 44: foundation.schema.Naming.AdditionalDomainName
	(*Endpoint)(nil),                      // 45: foundation.schema.Endpoint
	(*InternalEndpoint)(nil),              // 46: foundation.schema.InternalEndpoint
	(Endpoint_Type)(0),                    // 47: foundation.schema.Endpoint.Type
	(*anypb.Any)(nil),                     // 48: google.protobuf.Any
	(*BinaryConfig_EnvEntry)(nil),         // 49: foundation.schema.BinaryConfig.EnvEntry
	(*Endpoint_Port)(nil),                 // 50: foundation.schema.Endpoint.Port
	(Domain_ManagedType)(0),               // 51: foundation.schema.Domain.ManagedType
	(*ServiceMetadata)(nil),               // 52: foundation.schema.ServiceMetadata
}
var file_schema_schema_proto_depIdxs = []int32{
	7,  // 0: foundation.schema.Schema.service:type_name -> foundation.schema.Node
	7,  // 1: foundation.schema.Schema.extension:type_name -> foundation.schema.Node
	15, // 2: foundation.schema.Schema.server:type_name -> foundation.schema.Server
	25, // 3: foundation.schema.Stack.entry:type_name -> foundation.schema.Stack.Entry
	45, // 4: foundation.schema.Stack.endpoint:type_name -> foundation.schema.Endpoint
	46, // 5: foundation.schema.Stack.internal_endpoint:type_name -> foundation.schema.InternalEndpoint
	1,  // 6: foundation.schema.Node.kind:type_name -> foundation.schema.Node.Kind
	18, // 7: foundation.schema.Node.instantiate:type_name -> foundation.schema.Instantiate
	10, // 8: foundation.schema.Node.need:type_name -> foundation.schema.Need
	11, // 9: foundation.schema.Node.provides:type_name -> foundation.schema.Provides
	13, // 10: foundation.schema.Node.export_service:type_name -> foundation.schema.GrpcExportService
	9,  // 11: foundation.schema.Node.export_http:type_name -> foundation.schema.HttpPath
	47, // 12: foundation.schema.Node.ingress:type_name -> foundation.schema.Endpoint.Type
	8,  // 13: foundation.schema.Node.initializers:type_name -> foundation.schema.NodeInitializer
	0,  // 14: foundation.schema.Node.service_framework:type_name -> foundation.schema.Framework
	14, // 15: foundation.schema.Node.reference:type_name -> foundation.schema.Reference
	48, // 16: foundation.schema.Node.ext:type_name -> google.protobuf.Any
	22, // 17: foundation.schema.Node.required_storage:type_name -> foundation.schema.RequiredStorage
	26, // 18: foundation.schema.Node.environment_requirement:type_name -> foundation.schema.Node.EnvironmentRequirement
	0,  // 19: foundation.schema.NodeInitializer.framework:type_name -> foundation.schema.Framework
	27, // 20: foundation.schema.Need.port:type_name -> foundation.schema.Need.Port
	12, // 21: foundation.schema.Provides.type:type_name -> foundation.schema.TypeDef
	28, // 22: foundation.schema.Provides.available_in:type_name -> foundation.schema.Provides.AvailableIn
	18, // 23: foundation.schema.Provides.instantiate:type_name -> foundation.schema.Instantiate
	2,  // 24: foundation.schema.Reference.kind:type_name -> foundation.schema.Reference.Kind
	35, // 25: foundation.schema.Server.description:type_name -> foundation.schema.Server.Description
	48, // 26: foundation.schema.Server.ext:type_name -> google.protobuf.Any
	17, // 27: foundation.schema.Server.allocation:type_name -> foundation.schema.Allocation
	0,  // 28: foundation.schema.Server.framework:type_name -> foundation.schema.Framework
	32, // 29: foundation.schema.Server.binary:type_name -> foundation.schema.Server.Binary
	33, // 30: foundation.schema.Server.service:type_name -> foundation.schema.Server.ServiceSpec
	33, // 31: foundation.schema.Server.ingress:type_name -> foundation.schema.Server.ServiceSpec
	14, // 32: foundation.schema.Server.reference:type_name -> foundation.schema.Reference
	49, // 33: foundation.schema.Server.static_env:type_name -> foundation.schema.BinaryConfig.EnvEntry
	34, // 34: foundation.schema.Server.url_map:type_name -> foundation.schema.Server.URLMapEntry
	50, // 35: foundation.schema.Server.static_port:type_name -> foundation.schema.Endpoint.Port
	22, // 36: foundation.schema.Server.required_storage:type_name -> foundation.schema.RequiredStorage
	36, // 37: foundation.schema.Server.environment_requirement:type_name -> foundation.schema.Server.EnvironmentRequirement
	37, // 38: foundation.schema.Server.integration:type_name -> foundation.schema.Server.Integration
	16, // 39: foundation.schema.Server.volumes:type_name -> foundation.schema.Volume
	38, // 40: foundation.schema.Server.mounts:type_name -> foundation.schema.Server.Mount
	3,  // 41: foundation.schema.Volume.kind:type_name -> foundation.schema.Volume.Kind
	39, // 42: foundation.schema.Volume.persistent:type_name -> foundation.schema.Volume.Persistent
	40, // 43: foundation.schema.Volume.configurable:type_name -> foundation.schema.Volume.Configurable
	41, // 44: foundation.schema.Volume.package_sync:type_name -> foundation.schema.Volume.Fileset
	42, // 45: foundation.schema.Allocation.instance:type_name -> foundation.schema.Allocation.Instance
	48, // 46: foundation.schema.Instantiate.constructor:type_name -> google.protobuf.Any
	4,  // 47: foundation.schema.Environment.purpose:type_name -> foundation.schema.Environment.Purpose
	43, // 48: foundation.schema.Environment.labels:type_name -> foundation.schema.Environment.Label
	44, // 49: foundation.schema.Naming.additional_user_specified:type_name -> foundation.schema.Naming.AdditionalDomainName
	44, // 50: foundation.schema.Naming.additional_tls_managed:type_name -> foundation.schema.Naming.AdditionalDomainName
	23, // 51: foundation.schema.ComputedNaming.source:type_name -> foundation.schema.Naming
	51, // 52: foundation.schema.ComputedNaming.managed:type_name -> foundation.schema.Domain.ManagedType
	15, // 53: foundation.schema.Stack.Entry.server:type_name -> foundation.schema.Server
	23, // 54: foundation.schema.Stack.Entry.server_naming:type_name -> foundation.schema.Naming
	7,  // 55: foundation.schema.Stack.Entry.node:type_name -> foundation.schema.Node
	43, // 56: foundation.schema.Node.EnvironmentRequirement.environment_has_label:type_name -> foundation.schema.Environment.Label
	43, // 57: foundation.schema.Node.EnvironmentRequirement.environment_does_not_have_label:type_name -> foundation.schema.Environment.Label
	29, // 58: foundation.schema.Provides.AvailableIn.go:type_name -> foundation.schema.Provides.AvailableIn.Go
	30, // 59: foundation.schema.Provides.AvailableIn.web:type_name -> foundation.schema.Provides.AvailableIn.Web
	31, // 60: foundation.schema.Provides.AvailableIn.nodejs:type_name -> foundation.schema.Provides.AvailableIn.NodeJs
	52, // 61: foundation.schema.Server.ServiceSpec.metadata:type_name -> foundation.schema.ServiceMetadata
	50, // 62: foundation.schema.Server.ServiceSpec.port:type_name -> foundation.schema.Endpoint.Port
	43, // 63: foundation.schema.Server.EnvironmentRequirement.environment_has_label:type_name -> foundation.schema.Environment.Label
	43, // 64: foundation.schema.Server.EnvironmentRequirement.environment_does_not_have_label:type_name -> foundation.schema.Environment.Label
	18, // 65: foundation.schema.Allocation.Instance.instantiated:type_name -> foundation.schema.Instantiate
	17, // 66: foundation.schema.Allocation.Instance.downstream_allocation:type_name -> foundation.schema.Allocation
...
func file_schema_schema_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_schema_schema_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
		...
		file_schema_schema_proto_msgTypes[36].Exporter = func(v interface{}, i int) interface{} {
		...
		file_schema_schema_proto_msgTypes[37].Exporter = func(v interface{}, i int) interface{} {
		...
		file_schema_schema_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
		...
		file_schema_schema_proto_msgTypes[39].Exporter = func(v interface{}, i int) interface{} {
