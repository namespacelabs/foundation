...
type ComputedNaming struct {
	...
	UpstreamTlsTermination bool               `protobuf:"varint,4,opt,name=upstream_tls_termination,json=upstreamTlsTermination,proto3" json:"upstream_tls_termination,omitempty"` // If true, these addresses will be TLS terminated.
	DomainFragmentSuffix   string             `protobuf:"bytes,5,opt,name=domain_fragment_suffix,json=domainFragmentSuffix,proto3" json:"domain_fragment_suffix,omitempty"`        // If set, domain name generation will use this suffix rather than creating a new sub-domain.
	UseShortAlias          bool               `protobuf:"varint,6,opt,name=use_short_alias,json=useShortAlias,proto3" json:"use_short_alias,omitempty"`                            // Enable new endpoint alias generation.
	MainModuleName         string             `protobuf:"bytes,7,opt,name=main_module_name,json=mainModuleName,proto3" json:"main_module_name,omitempty"`
}
...
var file_schema_schema_proto_rawDesc = []byte{
	...
	0x64, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x66, 0x71, 0x64, 0x6e, 0x22, 0xe7,
	0x02, 0x0a, 0x0e, 0x43, 0x6f, 0x6d, 0x70, 0x75, 0x74, 0x65, 0x64, 0x4e, 0x61, 0x6d, 0x69, 0x6e,
	...
	0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x16, 0x75, 0x70, 0x73, 0x74, 0x72, 0x65,
	...
	0x65, 0x6e, 0x74, 0x5f, 0x73, 0x75, 0x66, 0x66, 0x69, 0x78, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09,
	...
	0x6f, 0x72, 0x74, 0x5f, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52,
	...
	0x6d, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x6d, 0x61, 0x69, 0x6e, 0x4d, 0x6f,
