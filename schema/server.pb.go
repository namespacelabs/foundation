...
const (
	...
	// Set when a server is defined using the new import-less syntax. Can't be set manually in CUE.
	Framework_BASE Framework = 5
)
...
type DeployableClass int32

const (
	DeployableClass_DEPLOYABLE_CLASS_UNSPECIFIED DeployableClass = 0
	// Represents a horizontally scalable stateless deployment.
	DeployableClass_STATELESS DeployableClass = 1
	// Represents a stateful deployment.
	DeployableClass_STATEFUL DeployableClass = 2
)

// Enum value maps for DeployableClass.
var (
	DeployableClass_name = map[int32]string{
		0: "DEPLOYABLE_CLASS_UNSPECIFIED",
		1: "STATELESS",
		2: "STATEFUL",
	}
	DeployableClass_value = map[string]int32{
		"DEPLOYABLE_CLASS_UNSPECIFIED": 0,
		"STATELESS":                    1,
		"STATEFUL":                     2,
	}
)

func (x DeployableClass) Enum() *DeployableClass {
	p := new(DeployableClass)
	*p = x
	return p
}

func (x DeployableClass) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DeployableClass) Descriptor() protoreflect.EnumDescriptor {
	return file_schema_server_proto_enumTypes[1].Descriptor()
}

func (DeployableClass) Type() protoreflect.EnumType {
	return &file_schema_server_proto_enumTypes[1]
}

func (x DeployableClass) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DeployableClass.Descriptor instead.
func (DeployableClass) EnumDescriptor() ([]byte, []int) {
...
type Server struct {
	...
	DeployableClass DeployableClass `protobuf:"varint,30,opt,name=deployable_class,json=deployableClass,proto3,enum=foundation.schema.DeployableClass" json:"deployable_class,omitempty"`
	...
	Mounts  []*Mount      `protobuf:"bytes,27,rep,name=mounts,proto3" json:"mounts,omitempty"`
	Secret  []*SecretSpec `protobuf:"bytes,28,rep,name=secret,proto3" json:"secret,omitempty"`
}
...
func (x *Server) GetDeployableClass() DeployableClass {
	if x != nil {
		return x.DeployableClass
	}
	return DeployableClass_DEPLOYABLE_CLASS_UNSPECIFIED
}
...
func (x *Server) GetSecret() []*SecretSpec {
	if x != nil {
		return x.Secret
	}
	return nil
...
type Server_Binary struct {
	...
	PackageRef *PackageRef `protobuf:"bytes,3,opt,name=package_ref,json=packageRef,proto3" json:"package_ref,omitempty"`
}
...
func (x *Server_Binary) GetPackageRef() *PackageRef {
	if x != nil {
		return x.PackageRef
	}
	return nil
...
var file_schema_server_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x33,
	...
	0x6d, 0x65, 0x73, 0x12, 0x30, 0x0a, 0x06, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x18, 0x1b, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x66, 0x6f, 0x75, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x4d, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x06, 0x6d,
	0x6f, 0x75, 0x6e, 0x74, 0x73, 0x12, 0x35, 0x0a, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x18,
	0x1c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x66, 0x6f, 0x75, 0x6e, 0x64, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74,
	0x53, 0x70, 0x65, 0x63, 0x52, 0x06, 0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x1a, 0x6a, 0x0a, 0x06,
	...
	0x6c, 0x74, 0x12, 0x3e, 0x0a, 0x0b, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x5f, 0x72, 0x65,
	...
	0x65, 0x66, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x1a, 0xcf, 0x01, 0x0a, 0x0b, 0x53, 0x65, 0x72,
	...
	0x65, 0x6c, 0x12, 0x3e, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x06,
	...
	0x74, 0x61, 0x12, 0x34, 0x0a, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b,
	...
	0x72, 0x74, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x69, 0x6e, 0x74, 0x65,
	0x72, 0x6e, 0x61, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x69, 0x6e, 0x74, 0x65,
	0x72, 0x6e, 0x61, 0x6c, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x1a, 0x88, 0x01, 0x0a, 0x0b, 0x55,
	...
	0x04, 0x6b, 0x69, 0x6e, 0x64, 0x1a, 0x50, 0x0a, 0x0b, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70,
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x12, 0x10, 0x0a, 0x03, 0x75, 0x72,
	...
	0x69, 0x63, 0x6f, 0x6e, 0x55, 0x72, 0x6c, 0x1a, 0xf8, 0x01, 0x0a, 0x16, 0x45, 0x6e, 0x76, 0x69,
	0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x69, 0x72, 0x65, 0x6d, 0x65,
	0x6e, 0x74, 0x12, 0x18, 0x0a, 0x07, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x12, 0x58, 0x0a, 0x15,
	0x65, 0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x68, 0x61, 0x73, 0x5f,
	0x6c, 0x61, 0x62, 0x65, 0x6c, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x66, 0x6f,
	0x75, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e,
	...
	0x73, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x12, 0x6a, 0x0a, 0x1f, 0x65, 0x6e, 0x76, 0x69, 0x72, 0x6f,
	...
	0x65, 0x6d, 0x61, 0x2e, 0x45, 0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65, 0x6e, 0x74, 0x2e,
	0x4c, 0x61, 0x62, 0x65, 0x6c, 0x52, 0x1b, 0x65, 0x6e, 0x76, 0x69, 0x72, 0x6f, 0x6e, 0x6d, 0x65,
	0x6e, 0x74, 0x44, 0x6f, 0x65, 0x73, 0x4e, 0x6f, 0x74, 0x48, 0x61, 0x76, 0x65, 0x4c, 0x61, 0x62,
	0x65, 0x6c, 0x4a, 0x04, 0x08, 0x11, 0x10, 0x12, 0x4a, 0x04, 0x08, 0x13, 0x10, 0x14, 0x4a, 0x04,
	0x08, 0x12, 0x10, 0x13, 0x4a, 0x04, 0x08, 0x16, 0x10, 0x17, 0x22, 0xde, 0x02, 0x0a, 0x0a, 0x41,
	...
	,
	...
	0x6f, 0x77, 0x6e, 0x65, 0x72, 0x12, 0x23, 0x0a, 0x0d, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x74, 0x61,
	0x72, 0x67, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x31, 0x0a, 0x06, 0x76, 0x6f,
	...
	0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x52, 0x06, 0x76, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x12, 0x2e, 0x0a,
	0x05, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x66,
	0x6f, 0x75, 0x6e, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61,
	0x2e, 0x4d, 0x6f, 0x75, 0x6e, 0x74, 0x52, 0x05, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x2a, 0x59, 0x0a,
	...
	0x10, 0x03, 0x12, 0x0a, 0x0a, 0x06, 0x4f, 0x50, 0x41, 0x51, 0x55, 0x45, 0x10, 0x04, 0x12, 0x08,
	0x0a, 0x04, 0x42, 0x41, 0x53, 0x45, 0x10, 0x05, 0x2a, 0x50, 0x0a, 0x0f, 0x44, 0x65, 0x70, 0x6c,
	0x6f, 0x79, 0x61, 0x62, 0x6c, 0x65, 0x43, 0x6c, 0x61, 0x73, 0x73, 0x12, 0x20, 0x0a, 0x1c, 0x44,
	0x45, 0x50, 0x4c, 0x4f, 0x59, 0x41, 0x42, 0x4c, 0x45, 0x5f, 0x43, 0x4c, 0x41, 0x53, 0x53, 0x5f,
	0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x0d, 0x0a,
	0x09, 0x53, 0x54, 0x41, 0x54, 0x45, 0x4c, 0x45, 0x53, 0x53, 0x10, 0x01, 0x12, 0x0c, 0x0a, 0x08,
	0x53, 0x54, 0x41, 0x54, 0x45, 0x46, 0x55, 0x4c, 0x10, 0x02, 0x42, 0x25, 0x5a, 0x23, 0x6e, 0x61,
...
var file_schema_server_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_schema_server_proto_goTypes = []interface{}{
	...
	(DeployableClass)(0),                  // 1: foundation.schema.DeployableClass
	...
	(*Server_Binary)(nil),                 // 7: foundation.schema.Server.Binary
	...
	(*SecretSpec)(nil),                    // 19: foundation.schema.SecretSpec
	(*PackageRef)(nil),                    // 20: foundation.schema.PackageRef
	(*ServiceMetadata)(nil),               // 21: foundation.schema.ServiceMetadata
	(*Environment_Label)(nil),             // 22: foundation.schema.Environment.Label
}
var file_schema_server_proto_depIdxs = []int32{
	...
	1,  // 4: foundation.schema.Server.deployable_class:type_name -> foundation.schema.DeployableClass
	7,  // 5: foundation.schema.Server.binary:type_name -> foundation.schema.Server.Binary
	8,  // 6: foundation.schema.Server.service:type_name -> foundation.schema.Server.ServiceSpec
	8,  // 7: foundation.schema.Server.ingress:type_name -> foundation.schema.Server.ServiceSpec
	14, // 8: foundation.schema.Server.reference:type_name -> foundation.schema.Reference
	15, // 9: foundation.schema.Server.static_env:type_name -> foundation.schema.BinaryConfig.EnvEntry
	9,  // 10: foundation.schema.Server.url_map:type_name -> foundation.schema.Server.URLMapEntry
	16, // 11: foundation.schema.Server.static_port:type_name -> foundation.schema.Endpoint.Port
	11, // 12: foundation.schema.Server.environment_requirement:type_name -> foundation.schema.Server.EnvironmentRequirement
	...
	19, // 15: foundation.schema.Server.secret:type_name -> foundation.schema.SecretSpec
	12, // 16: foundation.schema.Allocation.instance:type_name -> foundation.schema.Allocation.Instance
	13, // 17: foundation.schema.Instantiate.constructor:type_name -> google.protobuf.Any
	17, // 18: foundation.schema.ServerExtension.volume:type_name -> foundation.schema.Volume
	18, // 19: foundation.schema.ServerExtension.mount:type_name -> foundation.schema.Mount
	20, // 20: foundation.schema.Server.Binary.package_ref:type_name -> foundation.schema.PackageRef
	21, // 21: foundation.schema.Server.ServiceSpec.metadata:type_name -> foundation.schema.ServiceMetadata
	16, // 22: foundation.schema.Server.ServiceSpec.port:type_name -> foundation.schema.Endpoint.Port
	22, // 23: foundation.schema.Server.EnvironmentRequirement.environment_has_label:type_name -> foundation.schema.Environment.Label
	22, // 24: foundation.schema.Server.EnvironmentRequirement.environment_does_not_have_label:type_name -> foundation.schema.Environment.Label
	4,  // 25: foundation.schema.Allocation.Instance.instantiated:type_name -> foundation.schema.Instantiate
	3,  // 26: foundation.schema.Allocation.Instance.downstream_allocation:type_name -> foundation.schema.Allocation
