...
var file_schema_server_proto_goTypes = []interface{}{
	...
	(Endpoint_Type)(0),                    // 27: foundation.schema.Endpoint.Type
	(*PackageRef)(nil),                    // 28: foundation.schema.PackageRef
	(*DomainSpec)(nil),                    // 29: foundation.schema.DomainSpec
	(*ServiceAnnotations)(nil),            // 30: foundation.schema.ServiceAnnotations
	(*Label)(nil),                         // 31: foundation.schema.Label
}
var file_schema_server_proto_depIdxs = []int32{
	...
	18, // 28: foundation.schema.Server.ServiceSpec.port:type_name -> foundation.schema.Endpoint.Port
	27, // 29: foundation.schema.Server.ServiceSpec.endpoint_type:type_name -> foundation.schema.Endpoint.Type
	28, // 30: foundation.schema.Server.ServiceSpec.ingress_provider:type_name -> foundation.schema.PackageRef
	29, // 31: foundation.schema.Server.ServiceSpec.ingress_domain:type_name -> foundation.schema.DomainSpec
	30, // 32: foundation.schema.Server.ServiceSpec.ingress_annotations:type_name -> foundation.schema.ServiceAnnotations
	31, // 33: foundation.schema.Server.EnvironmentRequirement.environment_has_label:type_name -> foundation.schema.Label
	31, // 34: foundation.schema.Server.EnvironmentRequirement.environment_does_not_have_label:type_name -> foundation.schema.Label
