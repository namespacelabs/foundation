...
var file_schema_server_proto_rawDesc = []byte{
	...
	0x10, 0x27, 0x4a, 0x04, 0x08, 0x28, 0x10, 0x29, 0x22, 0xa9, 0x05, 0x0a, 0x0e, 0x53, 0x65, 0x72,
	...
	0x69, 0x6e, 0x65, 0x72, 0x22, 0xde, 0x02, 0x0a, 0x0a, 0x41, 0x6c, 0x6c, 0x6f, 0x63, 0x61, 0x74,
	...
	0x05, 0x2a, 0x59, 0x0a, 0x09, 0x46, 0x72, 0x61, 0x6d, 0x65, 0x77, 0x6f, 0x72, 0x6b, 0x12, 0x19,
	...
	0x01, 0x12, 0x0a, 0x0a, 0x06, 0x4f, 0x50, 0x41, 0x51, 0x55, 0x45, 0x10, 0x04, 0x12, 0x11, 0x0a,
	0x0d, 0x4f, 0x50, 0x41, 0x51, 0x55, 0x45, 0x5f, 0x4e, 0x4f, 0x44, 0x45, 0x4a, 0x53, 0x10, 0x05,
	0x22, 0x04, 0x08, 0x02, 0x10, 0x02, 0x22, 0x04, 0x08, 0x03, 0x10, 0x03, 0x42, 0x25, 0x5a, 0x23,
...
var file_schema_server_proto_goTypes = []interface{}{
	...
	(*ContainerExtension)(nil),            // 23: foundation.schema.ContainerExtension
	(*ServiceMetadata)(nil),               // 24: foundation.schema.ServiceMetadata
	(Endpoint_Type)(0),                    // 25: foundation.schema.Endpoint.Type
	(*PackageRef)(nil),                    // 26: foundation.schema.PackageRef
	(*DomainSpec)(nil),                    // 27: foundation.schema.DomainSpec
	(*ServiceAnnotations)(nil),            // 28: foundation.schema.ServiceAnnotations
...
var file_schema_server_proto_depIdxs = []int32{
	...
	13, // 20: foundation.schema.Allocation.instance:type_name -> foundation.schema.Allocation.Instance
	15, // 21: foundation.schema.Instantiate.constructor:type_name -> google.protobuf.Any
	14, // 22: foundation.schema.ServerPermissions.cluster_role:type_name -> foundation.schema.ServerPermissions.ClusterRole
	21, // 23: foundation.schema.ServerExtension.volume:type_name -> foundation.schema.Volume
	23, // 24: foundation.schema.ServerExtension.extend_container:type_name -> foundation.schema.ContainerExtension
	24, // 25: foundation.schema.Server.ServiceSpec.metadata:type_name -> foundation.schema.ServiceMetadata
	17, // 26: foundation.schema.Server.ServiceSpec.port:type_name -> foundation.schema.Endpoint.Port
	25, // 27: foundation.schema.Server.ServiceSpec.endpoint_type:type_name -> foundation.schema.Endpoint.Type
	26, // 28: foundation.schema.Server.ServiceSpec.ingress_provider:type_name -> foundation.schema.PackageRef
	27, // 29: foundation.schema.Server.ServiceSpec.ingress_domain:type_name -> foundation.schema.DomainSpec
	28, // 30: foundation.schema.Server.ServiceSpec.ingress_annotations:type_name -> foundation.schema.ServiceAnnotations
