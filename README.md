...
*Application development platform that uses your own application source code to drive build, test and prod. Enabling you to focus on developing your own services, rather than managing infrastructure.*

> ## Getting Started <br>
> Read an overview of our platform and instructions to get started at <br>
> **-> https://alpha.foundation.namespacelabs.com**


This repository contains the source code of Foundation's orchestration, language and runtime integration, as well as support for various services and extensions, presented as "nodes". Rest of this README is geared towards developing Foundation.
