...
func (svc *Service) Deploy(ctx context.Context, req *DeployRequest) (*DeployResponse, error) {
...
func (svc *Service) DeploymentStatus(ctx context.Context, req *DeploymentStatusRequest) (*DeploymentStatusResponse, error) {
...
func WireService(ctx context.Context, srv server.Registrar, deps ServiceDeps) {
	RegisterOrchestrationServiceServer(srv, &Service{})
}
