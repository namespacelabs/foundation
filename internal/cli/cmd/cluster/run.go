...
func NewRunCmd() *cobra.Command {
	...
	enableDocker := run.Flags().Bool("enable_docker", false, "If set to true, instructs the platform to also set up Docker in the container.")
	...
	userSshey := run.Flags().String("ssh_key", "", "Injects the specified SSH public key into the created instance.")
