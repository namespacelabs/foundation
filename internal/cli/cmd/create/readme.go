...
var (
	readmeTemplate = template.Must(template.New("readme").Parse(`# Welcome to Namespace!

Your starter project has been created!

{{if .DryRun -}}
This project has been generated by ` + "`" + `ns starter` + "`" + `. See the individual commands above that were executed.
