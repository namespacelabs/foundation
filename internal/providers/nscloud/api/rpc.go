...
func CreateCluster(ctx context.Context, api API, opts CreateClusterOpts) (*CreateInstanceResponse, error) {
	return tasks.Return(ctx, tasks.Action("nscloud.cluster-create").HumanReadable(opts.label()), func(ctx context.Context) (*CreateInstanceResponse, error) {
		tryOnce := func(ctx context.Context) (*CreateInstanceResponse, error) {
			...
			if err := api.CreateInstance.Do(ctx, req, endpoint.ResolveRegionalEndpoint, fnapi.DecodeJSONResponse(&resp)); err != nil {
...
func GetBuilderConfiguration(ctx context.Context, platform BuildPlatform, createAtStartup bool, builderTag string) (*builderv1beta.GetBuilderConfigurationResponse, error) {
	...
	return tasks.Return(ctx, tasks.Action("nsc.get-builder-configuration").HumanReadablef("Fetching Builder config for platform: %s", platform),
...
func EnsureBuildCluster(ctx context.Context, platform BuildPlatform) (*builderv1beta.EnsureBuildInstanceResponse, error) {
	...
	return tasks.Return(ctx, tasks.Action("nsc.ensure-build-cluster").HumanReadablef("Creating %s Build Cluster", platform),
...
func WaitClusterReady(ctx context.Context, api API, clusterId string, waitFor time.Duration, opts WaitClusterOpts) (*CreateClusterResult, error) {
	...
	if err := tasks.Action("nscloud.cluster-wait").HumanReadable(opts.label()).Arg("cluster_id", clusterId).Run(ctx, func(ctx context.Context) error {
