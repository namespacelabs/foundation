...
func WireServices(ctx context.Context, srv server.Server, depgraph core.Dependencies) []error {
	...
	if err := depgraph.Instantiate(ctx, localstacks3.Provider__akep8c, func(ctx context.Context, v interface{}) error {
		localstacks3.WireService(ctx, srv.Scope(localstacks3.Package__akep8c), v.(localstacks3.ServiceDeps))
		return nil
	}); err != nil {
