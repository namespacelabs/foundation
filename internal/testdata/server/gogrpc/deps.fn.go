...
func WireServices(ctx context.Context, srv server.Server, depgraph core.Dependencies) []error {
	...
	if err := depgraph.Instantiate(ctx, post.Provider__r11u7a, func(ctx context.Context, v interface{}) error {
		post.WireService(ctx, srv.Scope(post.Package__r11u7a), v.(post.ServiceDeps))
		return nil
	}); err != nil {
