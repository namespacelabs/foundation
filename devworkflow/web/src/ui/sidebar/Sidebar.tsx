...
export function Item(props: {
	...
	let body = (
		<a
			...
			{props.rightSide ? <div className={classes.itemRight}>{props.rightSide}</div> : null}
		</a>
	);
...
export function Collapsable(props: { icon: JSX.Element; title: string; children: ReactNode }) {
	return (
		<Block>
			<Item
				icon={props.icon}
