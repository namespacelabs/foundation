...
require (
	...
	buf.build/gen/go/namespace/cloud/protocolbuffers/go v1.36.6-20250331121718-98a5ed3e2bdc.1
	...
	namespacelabs.dev/integrations v0.0.1-dev.0.20250304201626-36177e269547
