...
type TLSCertificateSpec struct {
	...
	CommonNamePrefix string   `protobuf:"bytes,2,opt,name=common_name_prefix,json=commonNamePrefix,proto3" json:"common_name_prefix,omitempty"`
}
...
func (x *TLSCertificateSpec) GetCommonNamePrefix() string {
	if x != nil {
		return x.CommonNamePrefix
	}
	return ""
}
...
type CertificateChain struct {
	...
	CA     *Certificate `protobuf:"bytes,1,opt,name=CA,proto3" json:"CA,omitempty"`
	Server *Certificate `protobuf:"bytes,2,opt,name=Server,proto3" json:"Server,omitempty"`
}
...
func (x *CertificateChain) GetCA() *Certificate {
	if x != nil {
		return x.CA
	}
	return nil
...
func (x *CertificateChain) GetServer() *Certificate {
	if x != nil {
		return x.Server
	}
	return nil
...
func (x *Certificate) Reset() {
	*x = Certificate{}
	if protoimpl.UnsafeEnabled {
		mi := &file_std_types_certificates_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Certificate) Descriptor() ([]byte, []int) {
	return file_std_types_certificates_proto_rawDescGZIP(), []int{2}
}

func (x *Certificate) GetBundle() []byte {
	if x != nil {
		return x.Bundle
	}
	return nil
...
var file_std_types_certificates_proto_rawDesc = []byte{
	...
	,
...
var file_std_types_certificates_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_std_types_certificates_proto_goTypes = []interface{}{
	...
	(*Certificate)(nil),        // 2: foundation.std.types.Certificate
}
var file_std_types_certificates_proto_depIdxs = []int32{
	2, // 0: foundation.std.types.CertificateChain.CA:type_name -> foundation.std.types.Certificate
	2, // 1: foundation.std.types.CertificateChain.Server:type_name -> foundation.std.types.Certificate
...
func file_std_types_certificates_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_std_types_certificates_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
