...
import type { ServerCallWithMeta, SendUnaryDataCallback, GrpcEmitter, HandleCall } from "./types";
...
function serverStreamAndBidiHandler<RequestType, ResponseType>(
	...
	call.on("finish", () => {
		...
		span.setAttribute(SemanticAttributes.RPC_GRPC_STATUS_CODE, SpanStatusCode.OK.toString());
