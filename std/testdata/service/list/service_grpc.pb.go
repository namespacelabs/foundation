...
func (c *listServiceClient) Add(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/std.testdata.service.list.ListService/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *listServiceClient) List(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/std.testdata.service.list.ListService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ListService_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/std.testdata.service.list.ListService/Add",
	}
...
func _ListService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/std.testdata.service.list.ListService/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var ListService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "std.testdata.service.list.ListService",
	...
	Metadata: "std/testdata/service/list/service.proto",
}
