...
func (c *fileServiceClient) Add(ctx context.Context, in *AddFileRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/std.testdata.service.proto.FileService/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileServiceClient) Get(ctx context.Context, in *GetFileRequest, opts ...grpc.CallOption) (*GetFileResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/std.testdata.service.proto.FileService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FileService_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/std.testdata.service.proto.FileService/Add",
	}
...
func _FileService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/std.testdata.service.proto.FileService/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "std.testdata.service.proto.FileService",
	...
	Metadata: "std/testdata/service/proto/file.proto",
}
