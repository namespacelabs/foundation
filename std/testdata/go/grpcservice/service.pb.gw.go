...
func RegisterPostServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PostServiceServer) error {
	...
	mux.Handle("POST", pattern_PostService_Post_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/std.testdata.go.grpcservice.PostService/Post", runtime.WithHTTPPathPattern("/std.testdata.go.grpcservice.PostService/Post"))
		if err != nil {
...
func RegisterPostServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PostServiceClient) error {
	...
	mux.Handle("POST", pattern_PostService_Post_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/std.testdata.go.grpcservice.PostService/Post", runtime.WithHTTPPathPattern("/std.testdata.go.grpcservice.PostService/Post"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_PostService_Post_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"std.testdata.go.grpcservice.PostService", "Post"}, ""))
)
