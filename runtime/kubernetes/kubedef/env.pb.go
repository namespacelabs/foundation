...
var file_runtime_kubernetes_kubedef_env_proto_goTypes = []interface{}{
	...
	(*types.TLSCertificateSpec)(nil),            // 25: foundation.std.types.TLSCertificateSpec
}
var file_runtime_kubernetes_kubedef_env_proto_depIdxs = []int32{
	...
	25, // 11: foundation.runtime.kubernetes.kubedef.OpCreateSecretConditionally.self_signed_certificate:type_name -> foundation.std.types.TLSCertificateSpec
	22, // 12: foundation.runtime.kubernetes.kubedef.OpApplyRoleBinding.label:type_name -> foundation.runtime.kubernetes.kubedef.OpApplyRoleBinding.KeyValue
	22, // 13: foundation.runtime.kubernetes.kubedef.OpApplyRoleBinding.annotation:type_name -> foundation.runtime.kubernetes.kubedef.OpApplyRoleBinding.KeyValue
	13, // 14: foundation.runtime.kubernetes.kubedef.SpecExtension.Volume.secret:type_name -> foundation.runtime.kubernetes.kubedef.SpecExtension.Volume.Secret
	14, // 15: foundation.runtime.kubernetes.kubedef.SpecExtension.Volume.config_map:type_name -> foundation.runtime.kubernetes.kubedef.SpecExtension.Volume.ConfigMap
	15, // 16: foundation.runtime.kubernetes.kubedef.SpecExtension.Volume.ConfigMap.item:type_name -> foundation.runtime.kubernetes.kubedef.SpecExtension.Volume.ConfigMap.Item
