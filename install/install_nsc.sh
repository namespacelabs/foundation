...
do_install() {
  ...
  echo
  echo "Note: nsc collects usage telemetry. This data helps us build a better "
  ...
  echo "Manually add the directory to your \$HOME/$shell_profile (or similar)" #TODO needed for nsc? can we simplify?
  ...
  echo
  echo "Check out our examples at https://namespace.so/docs#examples to get started." #TODO fix for nsc
  echo
}
