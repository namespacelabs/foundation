...
type ClusterInstance struct {
	...
	PublicBaseUrl string `protobuf:"bytes,2,opt,name=public_base_url,json=publicBaseUrl,proto3" json:"public_base_url,omitempty"` // Optional.
}
...
func (x *ClusterInstance) GetPublicBaseUrl() string {
	if x != nil {
