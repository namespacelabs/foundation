...
func (x *SelfSignedProvider) Reset() {
	*x = SelfSignedProvider{}
	if protoimpl.UnsafeEnabled {
...
func (x *SelfSignedProvider) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SelfSignedProvider) ProtoMessage() {}

func (x *SelfSignedProvider) ProtoReflect() protoreflect.Message {
	mi := &file_universe_vault_types_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SelfSignedProvider.ProtoReflect.Descriptor instead.
func (*SelfSignedProvider) Descriptor() ([]byte, []int) {
	return file_universe_vault_types_proto_rawDescGZIP(), []int{5}
}

func (x *SelfSignedProvider) GetCommonName() string {
	if x != nil {
		return x.CommonName
	}
	return ""
...
var file_universe_vault_types_proto_rawDesc = []byte{
	...
	0x64, 0x22, 0x35, 0x0a, 0x12, 0x53, 0x65, 0x6c, 0x66, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x50,
	0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x63, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x42, 0x2d, 0x5a, 0x2b, 0x6e, 0x61, 0x6d, 0x65,
...
var file_universe_vault_types_proto_goTypes = []interface{}{
	...
	(*SelfSignedProvider)(nil),   // 5: foundation.universe.vault.SelfSignedProvider
}
...
func file_universe_vault_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_universe_vault_types_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SelfSignedProvider); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
