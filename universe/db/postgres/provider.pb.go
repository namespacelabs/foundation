...
type DatabaseArgs struct {
	...
	MaxConnsIdleTime                  *durationpb.Duration `protobuf:"bytes,5,opt,name=max_conns_idle_time,json=maxConnsIdleTime,proto3" json:"max_conns_idle_time,omitempty"` // Deprecated: use max_conns_idle_time_ms; unusable from CUE.
	...
	StatementTimeoutMs                int32                `protobuf:"varint,10,opt,name=statement_timeout_ms,json=statementTimeoutMs,proto3" json:"statement_timeout_ms,omitempty"`
	ConnectTimeoutMs                  int32                `protobuf:"varint,9,opt,name=connect_timeout_ms,json=connectTimeoutMs,proto3" json:"connect_timeout_ms,omitempty"`
	MaxConnsIdleTimeMs                int32                `protobuf:"varint,11,opt,name=max_conns_idle_time_ms,json=maxConnsIdleTimeMs,proto3" json:"max_conns_idle_time_ms,omitempty"`                  // Set if > 0.
	MaxConnLifetimeJitterMs           int32                `protobuf:"varint,12,opt,name=max_conn_lifetime_jitter_ms,json=maxConnLifetimeJitterMs,proto3" json:"max_conn_lifetime_jitter_ms,omitempty"`   // Set if > 0.
	VerifyServerCertificate           *bool                `protobuf:"varint,13,opt,name=verify_server_certificate,json=verifyServerCertificate,proto3,oneof" json:"verify_server_certificate,omitempty"` // Opt in to database certificate and hostname verification.
}
...
func (x *DatabaseArgs) GetStatementTimeoutMs() int32 {
	if x != nil {
...
func (x *DatabaseArgs) GetConnectTimeoutMs() int32 {
	if x != nil {
...
func (x *DatabaseArgs) GetMaxConnsIdleTimeMs() int32 {
	if x != nil {
		return x.MaxConnsIdleTimeMs
	}
	return 0
}

func (x *DatabaseArgs) GetMaxConnLifetimeJitterMs() int32 {
	if x != nil {
		return x.MaxConnLifetimeJitterMs
	}
	return 0
}

func (x *DatabaseArgs) GetVerifyServerCertificate() bool {
	if x != nil && x.VerifyServerCertificate != nil {
...
type FactoryArgs struct {
	...
	VerifyServerCertificate *bool  `protobuf:"varint,2,opt,name=verify_server_certificate,json=verifyServerCertificate,proto3,oneof" json:"verify_server_certificate,omitempty"` // Opt in to database certificate and hostname verification.
}
...
func (x *FactoryArgs) GetVerifyServerCertificate() bool {
	if x != nil && x.VerifyServerCertificate != nil {
		return *x.VerifyServerCertificate
	}
	return false
...
var file_universe_db_postgres_provider_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xed, 0x04, 0x0a, 0x0c, 0x44, 0x61, 0x74, 0x61, 0x62,
	...
	,
	...
	,
...
func file_universe_db_postgres_provider_proto_init() {
	...
	file_universe_db_postgres_provider_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_universe_db_postgres_provider_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
