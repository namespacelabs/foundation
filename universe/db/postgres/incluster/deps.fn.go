...
func makeDeps__udoubi(ctx context.Context, di core.Dependencies) (interface{}, error) {
	var deps ExtensionDeps
	var err error

	err = di.Instantiate(ctx, creds.Provider__9gpcgr, func(ctx context.Context, v interface{}) (err error) {
