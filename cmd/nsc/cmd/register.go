...
import (
	...
	"namespacelabs.dev/foundation/internal/cli/cmd/cluster/windows"
...
func RegisterCommands(root *cobra.Command) {
	...
	root.AddCommand(cluster.NewEgressCmd())                     // nsc egress
	...
	root.AddCommand(cluster.NewReapiCmd())
...
func newGithub() *cobra.Command {
	...
	cmd.AddCommand(github.NewJobsCmd())
	cmd.AddCommand(github.NewImagesCmd())
